...
export const categories = [
  ...
  { label: "Island", icon: GiIsland, description: "This property is on an island!" },
  ...
  { label: "Desert", icon: GiCactus, description: "This property is located near the desert!" },
  { label: "Barns", icon: GiBarn, description: "This property is located near the desert!" },
